...
public class Create {
	...
	try {			
			...
			// create the object
			Instructor tempInstructor= new Instructor("Furkan","KARA", "furkan@gmail.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.furkan.com","Luv 2 code!!"); 
